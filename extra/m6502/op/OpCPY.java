...
public class OpCPY implements IOpCode2<M6502> {

	private IAddrMode addrMode;
	
	public OpCPY(IAddrMode iAddrMode) {
		this.addrMode = iAddrMode;
	}
	
	@Override
	public int execute(M6502 cpu) {
		int val = cpu.getY() - addrMode.fetchValue(cpu);
	...
	public String disassemble(M6502 cpu) {
		return "CPY " + addrMode.disassemble(cpu);
	}	
}
